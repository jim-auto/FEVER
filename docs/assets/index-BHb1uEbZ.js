...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function fo(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ya(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function po(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ya(),fragmentShader:`
...
`)}function xp(i,t){let e;switch(t){case ac:e="Linear";break;case oc:e="Reinhard";break;case lc:e="Cineon";break;case zo:e="ACESFilmic";break;case hc:e="AgX";break;case uc:e="Neutral";break;case cc:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const xs=new L;function Mp(){qt.getLuminanceCoefficients(xs);const i=xs.x.toFixed(4),t=xs.y.toFixed(4),e=xs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Ep(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function Oi(i){return i!==""}function To(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function wo(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const bp=/^[ \t]*#include +<([\w\d./]+)>/gm;function aa(i){return i.replace(bp,wp)}const Tp=new Map;function wp(i,t){let e=It[t];if(e===void 0){const n=Tp.get(t);if(n!==void 0)e=It[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return aa(e)}const Ap=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ao(i){return i.replace(Ap,Rp)}function Rp(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ro(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function Cp(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Bo?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===kl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===on&&(t="SHADOWMAP_TYPE_VSM"),t}function Pp(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case _i:case vi:t="ENVMAP_TYPE_CUBE";break;case Ls:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Dp(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case vi:t="ENVMAP_MODE_REFRACTION";break}return t}function Lp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ko:t="ENVMAP_BLENDING_MULTIPLY";break;case sc:t="ENVMAP_BLENDING_MIX";break;case rc:t="ENVMAP_BLENDING_ADD";break}return t}function Ip(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Up(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Cp(e),c=Pp(e),h=Dp(e),d=Lp(e),f=Ip(e),m=Sp(e),v=yp(r),M=s.createProgram();let p,u,T=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `,this.ticketEl=this.root.querySelector("#patient-ticket"),this.subtitleEl=this.root.querySelector("#subtitle-bar"),this.promptEl=this.root.querySelector("#interaction-prompt"),this.eyesEl=this.root.querySelector("#eyes-closed"),this.phoneEl=this.root.querySelector("#phone-overlay"),this.phoneDialog=this.root.querySelector("#phone-dialog"),this.startScreen=this.root.querySelector("#start-screen"),this.feverTint=this.root.querySelector("#fever-tint"),this.feverVision=this.root.querySelector("#fever-vision"),this.sceneFade=this.root.querySelector("#scene-fade"),this.objectiveEl=this.root.querySelector(".objective-display"),this.choiceEl=this.root.querySelector("#choice-overlay"),this.choiceDialog=this.root.querySelector("#choice-dialog"),this.tempEl=this.root.querySelector(".temp-value"),this.bindA11y(),this.updatePatientTicket(),this.updateFeverLayer(Qe.WHITE)}bindA11y(){const t=this.root.querySelector("#a11y-toggle"),e=this.root.querySelector("#a11y-menu");t.addEventListener("click",()=>e.classList.toggle("open"));const n=(s,r)=>{this.root.querySelector(s).addEventListener("change",a=>{var o;this.a11y[r]=a.target.checked,document.body.classList.toggle("reduced-motion",this.a11y.reducedMotion),this.a11y.reducedMotion&&(this.feverVision.style.opacity="0"),r==="reducedTint"&&(this.feverTint.style.opacity=a.target.checked?"0.3":""),(o=this.onA11yChange)==null||o.call(this,this.a11y)})};n("#a11y-motion","reducedMotion"),n("#a11y-shake","reducedShake"),n("#a11y-subtitles","fixedSubtitles"),n("#a11y-text-layer","showTextLayer"),n("#a11y-tint","reducedTint"),n("#a11y-audio","reducedAudio"),n("#a11y-mute","muted"),n("#a11y-tinnitus","tinnitus")}onStart(t){this.root.querySelector("#start-btn").addEventListener("click",()=>{this.startScreen.classList.add("hidden"),t()})}updatePatientTicket(){const t=this.state.patientTicket;this.ticketEl.innerHTML=`
      ...
      ${_m.map(([e,n])=>{const s=e==="temperature"?t[e].toFixed(1):t[e],r=e==="appointment"&&t[e]==="赤";return`<div class="patient-ticket__row">
